...
SELECT artist, COUNT(*) AS total_num_track
FROM spotify
GROUP BY artist
ORDER BY total_num_track ASC;
...
SELECT 
    artist,track,album,energy,liveness,(energy / NULLIF(liveness, 0)) AS energy_liveness_ratio
FROM 
    spotify
WHERE 
